...
var methods = {
  ...
  setCropBoxData: function setCropBoxData(data) {
    ...
    if (this.ready && this.cropped && !this.disabled && isPlainObject(data)) {
      ...
      if (isNumber(data.minWidth) && data.minWidth !== cropBoxData.minWidth) {
        cropBoxData.minWidth = data.minWidth;
      }

      if (
        isNumber(data.minHeight) &&
        data.minHeight !== cropBoxData.minHeight
      ) {
        cropBoxData.minHeight = data.minHeight;
      }
